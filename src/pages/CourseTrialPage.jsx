      ...
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50 p-8">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for trying out this course. To continue learning, please
          ...
          <Link
            to="/services"
            className="block mt-4 text-teal-600 hover:underline"
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 animate-fade-in-down">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                This lesson is part of the full course. Purchase the complete
                course to unlock all content and features.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-2">
              <p className="text-sm text-gray-500 mb-3 px-2">
                <span className="font-medium">Trial access:</span> First 2
                lessons only
              </p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-black rounded-lg overflow-hidden shadow-lg mb-6">
              {currentLesson &&
              currentLesson.video_courses &&
              currentLesson.video_courses.length > 0 ? (
                <>
                  {renderVideo(
                    currentLesson.video_courses[selectedVideoIndex].link
                  )}
                ...
                <div className="flex justify-center items-center aspect-video bg-gray-800 text-white">
                  <div className="text-center p-6">
                    ...
                    <p className="text-sm text-gray-400 mt-2">
                      This is a preview of {course.name}. Purchase the full
                      course for complete access.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <h2 className="text-2xl font-bold mb-4">
                ...
                <span className="ml-2 text-sm bg-teal-100 text-blue-800 px-2 py-1 rounded">
                  Trial
                </span>
              </h2>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-md p-6 text-white">
              ...
              <p className="mb-4">
                Unlock the full course to access all lessons, exercises, and
                earn a certificate.
              </p>
              <button
                onClick={handlePurchaseCourse}
